...
declare const CreateImageToVideoGeneration: {
    readonly body: {
        readonly properties: {
            ...
            readonly resolution: {
                readonly title: "String";
                readonly enum: readonly ["RESOLUTION_480", "RESOLUTION_720"];
                readonly description: "The resolution of the video. Defaults to RESOLUTION_480 if not specified.";
    ...
    readonly body: {
        readonly properties: {
            ...
            readonly resolution: {
                readonly title: "String";
                readonly enum: readonly ["RESOLUTION_480", "RESOLUTION_720"];
                readonly description: "The resolution of the video. Defaults to RESOLUTION_480 if not specified. VEO3 only supports RESOLUTION_720.";
                readonly default: "RESOLUTION_480";
            };
            readonly model: {
                readonly title: "String";
            ...
            readonly styleIds: {
                ...
                readonly description: "Optional predefined styles to enhance the prompt";
            };
            readonly height: {
                readonly title: "Integer";
                readonly type: "integer";
                readonly description: "Height of the output";
                readonly default: 480;
            };
            readonly width: {
                readonly title: "Integer";
                readonly type: "integer";
                readonly description: "Width of the output";
